...
- Update repo URLs from ernestkoe to proofgeist
  ([`0730401`](https://github.com/proofgeist/obsidian-notes-rag/commit/0730401a8bf4010bff68bdd73ec62c69e4ef545e))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

### Documentation

- Add watcher service, release process, and repo URL to CLAUDE.md
  ([`c8e3c18`](https://github.com/proofgeist/obsidian-notes-rag/commit/c8e3c18e98a425645b87df4c7cab3905d1deff16))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

### Features

- Configurable chunking and search via [indexer] in config.toml
  ([#12](https://github.com/proofgeist/obsidian-notes-rag/pull/12),
  [`ca2910a`](https://github.com/proofgeist/obsidian-notes-rag/commit/ca2910a2d8ceb33639213111a50fd64b6a10f740))
...
- Make VectorStore thread-safe for watcher daemon
  ([#11](https://github.com/proofgeist/obsidian-notes-rag/pull/11),
  [`36c236a`](https://github.com/proofgeist/obsidian-notes-rag/commit/36c236a6a446f5c2d46f5f6ab89cca53703de64c))
...
- Use get_data_path() to resolve Optional[str] type error
  ([`db4629e`](https://github.com/proofgeist/obsidian-notes-rag/commit/db4629e9877f5fbbe70923dab68ab871076599a5))
...
- Add general upgrade instructions to README
  ([`0073d54`](https://github.com/proofgeist/obsidian-notes-rag/commit/0073d5492001b2fd1d2ffb30256a29fbec913d56))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Add guidance on using CLI with AI coding assistants
  ([`d5b01c5`](https://github.com/proofgeist/obsidian-notes-rag/commit/d5b01c524a54dd30497c8c0d1123ba8cb4de0d13))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Make README MCP-client-agnostic
  ([`4a57b03`](https://github.com/proofgeist/obsidian-notes-rag/commit/4a57b037f88eaaf6c9a411b2e48c5847464dfa24))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Update README for v1.0.0
  ([`f3955d1`](https://github.com/proofgeist/obsidian-notes-rag/commit/f3955d18efd8458f3e218270067c3ab6ead79db2))
...
- Replace ChromaDB with sqlite-vec, extend CLI
  ([#10](https://github.com/proofgeist/obsidian-notes-rag/pull/10),
  [`e0bc157`](https://github.com/proofgeist/obsidian-notes-rag/commit/e0bc157938689756d155005c32d8ba30e44760b8))
...
- Prevent infinite retry loop for deleted/temp files
  ([`8d01202`](https://github.com/proofgeist/obsidian-notes-rag/commit/8d01202b36103b92feeba51f7d4710c47580dd4a))
...
- Add Phase 5 CoreML embedding provider to roadmap
  ([`4574ffb`](https://github.com/proofgeist/obsidian-notes-rag/commit/4574ffb3502ab22dca80e30b63a5a9a778deb266))
...
- Prevent crash loop from filling disk with logs
  ([`0388bc8`](https://github.com/proofgeist/obsidian-notes-rag/commit/0388bc8c1ac8e9e4cb07643b1e9dd38cc498af28))
...
- Handle ChromaDB version incompatibility gracefully
  ([`bd03c4e`](https://github.com/proofgeist/obsidian-notes-rag/commit/bd03c4e37a5b75eaf61d04123cb6953ead2f738b))
...
- Gitignore .atlas directory
  ([`9fd567a`](https://github.com/proofgeist/obsidian-notes-rag/commit/9fd567ac2eb38187715d5dfa4c1e3c2ff67fdc2a))
...
- Correct semantic-release config and workflow
  ([`9ca110f`](https://github.com/proofgeist/obsidian-notes-rag/commit/9ca110f4867a2d43b88c5c4680cf29ef413b4e1b))
...
- Remove build_command from semantic-release config
  ([`eac6a77`](https://github.com/proofgeist/obsidian-notes-rag/commit/eac6a7785872a15eeaa88fb96953bfa880510dd0))
...
- Resolve macOS path case issues and pin ChromaDB version
  ([`e5900c5`](https://github.com/proofgeist/obsidian-notes-rag/commit/e5900c59fdc0df52b4dabbfc81b082d6a8043b25))
...
- Resolve pyright type error for chromadb Include parameter
  ([`b80b0d9`](https://github.com/proofgeist/obsidian-notes-rag/commit/b80b0d9a8eab3d2d3bab8ec080e6a1205be602a8))
...
- Resolve pyright type errors
  ([`ebc7a4d`](https://github.com/proofgeist/obsidian-notes-rag/commit/ebc7a4d4651270cd312607af1e117e7e00dcae11))
...
- Suppress pyright version warning by forcing latest
  ([`0af1c36`](https://github.com/proofgeist/obsidian-notes-rag/commit/0af1c36817abe5e44d81ca2b050944e69e7eecf2))
...
- Update README with LM Studio support and service improvements
  ([`c971fa3`](https://github.com/proofgeist/obsidian-notes-rag/commit/c971fa360f4a19395994d7e9b1c134efb5073456))
...
- Show 'obsidian-notes-rag' in Activity Monitor instead of python3
  ([`b9c1502`](https://github.com/proofgeist/obsidian-notes-rag/commit/b9c15023d5b4479797c9f1fa85ee9c73f67e74c4))
...
- Show descriptive name in macOS System Settings
  ([`590d86c`](https://github.com/proofgeist/obsidian-notes-rag/commit/590d86ccedb69fea66f4c0f2a3e1b181bb6820d9))
...
- Switch from release-please to python-semantic-release
  ([`b3e3da6`](https://github.com/proofgeist/obsidian-notes-rag/commit/b3e3da69bf8f152b185f1d2318d89ebc43a9d861))
...
- Update launchd service name to obsidian-notes-rag
  ([`1ba651a`](https://github.com/proofgeist/obsidian-notes-rag/commit/1ba651a54b8d0de8116051c1320fd3f06cd2f4c3))
...
- Add TODO for improving macOS login item appearance
  ([`e99467b`](https://github.com/proofgeist/obsidian-notes-rag/commit/e99467b13b04de8de9fbf34fc17091a874d7f96a))
...
- **main**: Release 0.3.0
  ([`d62b21f`](https://github.com/proofgeist/obsidian-notes-rag/commit/d62b21f35477bd205df181417daff3ec431ece24))

### Continuous Integration

- Add manual publish option to release workflow
  ([`1c31b12`](https://github.com/proofgeist/obsidian-notes-rag/commit/1c31b12d36ac9629f18da822e92a6cf32e8adb5b))
...
- Rename workflow to match PyPI trusted publisher
  ([`36dbe60`](https://github.com/proofgeist/obsidian-notes-rag/commit/36dbe6097f7b12e656cec2cbd1d9f5d4ce558daf))
...
- Add LM Studio support with auto model detection
  ([`745f5aa`](https://github.com/proofgeist/obsidian-notes-rag/commit/745f5aab0bce0650d9dad5c681d4debae1c9cd87))
...
- **indexer**: Add Chonkie for smart chunking of oversized content
  ([`819d3dd`](https://github.com/proofgeist/obsidian-notes-rag/commit/819d3ddc618d1d5aecae27fedba8695695475c5e))
...
- **setup**: Offer watcher service installation during setup
  ([`a3c96ff`](https://github.com/proofgeist/obsidian-notes-rag/commit/a3c96ff48517881fbd59642d027ea04d1ef61abc))
...
- **watcher**: Add health checks, retry queue, and notifications
  ([`6587d04`](https://github.com/proofgeist/obsidian-notes-rag/commit/6587d04fea5124ecd2b0faa38360afcb142e1528))
...
- **main**: Release 0.2.2
  ([`852a340`](https://github.com/proofgeist/obsidian-notes-rag/commit/852a340c5bd555997a275ba1f9dd088a650968f8))

### Continuous Integration

- Combine release-please with PyPI publish
  ([`6ba322b`](https://github.com/proofgeist/obsidian-notes-rag/commit/6ba322bb260ccf684017fd17011b98f18bba324e))
...
- Remove redundant manual release workflow
  ([`76799be`](https://github.com/proofgeist/obsidian-notes-rag/commit/76799bebba1018509f6e2e378a865fedc287c401))
...
- Add Buy Me A Coffee badge
  ([`9a40405`](https://github.com/proofgeist/obsidian-notes-rag/commit/9a40405b8f47e35c968767768fb0b19640ca34a8))
...
- Update CLAUDE.md with correct package name and PyPI link
  ([`d710ed4`](https://github.com/proofgeist/obsidian-notes-rag/commit/d710ed48c86789b4eb1ed7490436e49c9e4169ea))
...
- Update package branding to obsidian-notes-rag
  ([`7cad58b`](https://github.com/proofgeist/obsidian-notes-rag/commit/7cad58b4027b28a70635ae1d6d3329e26f42e07a))
...
- **main**: Release 0.2.1
  ([`57fd57d`](https://github.com/proofgeist/obsidian-notes-rag/commit/57fd57df71b6923873a90b8e6337b9b82b45e592))

### Refactoring

- Rename repo to obsidian-notes-rag
  ([`cf1e90b`](https://github.com/proofgeist/obsidian-notes-rag/commit/cf1e90b651d8c1c5519b578eeca101590234cd39))
...
- Suppress httpx logs during indexing progress bar
  ([`75e16a4`](https://github.com/proofgeist/obsidian-notes-rag/commit/75e16a459742716f1e7466ea7cb416e7f06ad281))
...
- Update setup completion message with correct package name
  ([`41ba859`](https://github.com/proofgeist/obsidian-notes-rag/commit/41ba85906c20da50d67c69872c8dcf841ecd1020))
...
- Use pypi environment for trusted publishing
  ([`227fe16`](https://github.com/proofgeist/obsidian-notes-rag/commit/227fe16629df9d6dd277ded144e8e07a87c34631))
...
- **main**: Release 0.2.0
  ([`392aea4`](https://github.com/proofgeist/obsidian-notes-rag/commit/392aea4523878e5c363f4c8b982b52a0a973edd6))

### Documentation

- Add Claude Desktop JSON config example
  ([`6b17b45`](https://github.com/proofgeist/obsidian-notes-rag/commit/6b17b45aed6810d114803f66872927c7e90e3743))
...
- Update CLAUDE.md CLI commands to use new package name
  ([`48d17ab`](https://github.com/proofgeist/obsidian-notes-rag/commit/48d17ab1e937f879d7da1b768d81c25181fcfc97))
...
- Update CLI commands for new package name
  ([`71c708f`](https://github.com/proofgeist/obsidian-notes-rag/commit/71c708f88f7dde15ea0b432d9c95c6f0919d18ee))
...
- Rename package to obsidian-notes-rag
  ([`ab78ec8`](https://github.com/proofgeist/obsidian-notes-rag/commit/ab78ec80e3cdb59d9713e33e6a263a0446bce311))
...
- Disable attestations for token-based auth
  ([`8d70f98`](https://github.com/proofgeist/obsidian-notes-rag/commit/8d70f989f3e50c7d9f6a5f045d0cc767646c0686))
...
- Use API token for PyPI publish
  ([`51a2c09`](https://github.com/proofgeist/obsidian-notes-rag/commit/51a2c0958e226b128a2a34c9ec0a8e2c75102a93))
...
- **main**: Release 0.1.2
  ([`f181c07`](https://github.com/proofgeist/obsidian-notes-rag/commit/f181c0706ec6e91b7a6dedd276eea91081875ea9))
...
- Add manual trigger to release workflow
  ([`130dfd0`](https://github.com/proofgeist/obsidian-notes-rag/commit/130dfd0cfddce817863998042ee783791b8204a9))
...
- **main**: Release 0.1.1
  ([`05c4e39`](https://github.com/proofgeist/obsidian-notes-rag/commit/05c4e3917df64e92edfa8d515365c030bbd900ef))

### Continuous Integration

- Add PyPI release workflow
  ([`8ae9f77`](https://github.com/proofgeist/obsidian-notes-rag/commit/8ae9f771194e53cec89b808f2695093d4055d849))
...
- **main**: Release 0.1.0
  ([`1132c90`](https://github.com/proofgeist/obsidian-notes-rag/commit/1132c90e8ad1dfbcf429d04ac9c23e5e2e75b681))

### Continuous Integration

- Add manual trigger to release-please workflow
  ([`0548823`](https://github.com/proofgeist/obsidian-notes-rag/commit/0548823ed9664a58609a16e7592b28636c2bda05))

### Documentation

- Add TODOs for Linux/Windows service support
  ([`569a830`](https://github.com/proofgeist/obsidian-notes-rag/commit/569a830b5272c7fdd0c8ba826063b765706ecdcf))
...
- Add file watcher daemon with launchd integration
  ([`23d2429`](https://github.com/proofgeist/obsidian-notes-rag/commit/23d2429c61d82e98610c0180f7044b807ad9cd60))
...
- Add OpenAI embeddings and setup wizard
  ([`e1e363e`](https://github.com/proofgeist/obsidian-notes-rag/commit/e1e363ee26a70d82635d7c8bf2bec38afaf28383))
...
- Consolidate CLI entry points for uvx workflow
  ([`95eb546`](https://github.com/proofgeist/obsidian-notes-rag/commit/95eb546b0a7d6d89d30da8d0dd4f7c4c64600657))
...
- Rename package to obsidian-rag
  ([`669d7e7`](https://github.com/proofgeist/obsidian-notes-rag/commit/669d7e797edd64e03f2ea46b0e3a894c4763fb1b))
...
- Rename project to mcp-obsidianRAG
  ([`16a83d9`](https://github.com/proofgeist/obsidian-notes-rag/commit/16a83d9ebe142f25231a33824b7c27237f61da73))
...
- Rename repo to obsidian-rag
  ([`96d64e4`](https://github.com/proofgeist/obsidian-notes-rag/commit/96d64e4cc03ccb26a1d942ae3970620845b51dc0))
